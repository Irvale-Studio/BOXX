    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="mt-6 text-white/60 text-lg md:text-xl max-w-md tracking-wide"
        >
        ...
        <motion.div
          ...
          className="w-16 h-[1px] bg-accent mt-8 origin-center"
        />
        ...
        <motion.button
          ...
          className="mt-8 px-8 py-3.5 border border-white/20 text-sm tracking-widest uppercase hover:bg-white hover:text-black transition-all duration-500"
        >
          Explore Classes
        </motion.button>
      </motion.div>
