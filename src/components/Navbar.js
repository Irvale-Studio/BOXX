...
export default function Navbar() {
  ...
  const socialLinks = useMemo(() => [
    settings.social_instagram && { name: 'Instagram', href: settings.social_instagram, icon: socialIcons.instagram },
    settings.social_tiktok && { name: 'TikTok', href: settings.social_tiktok, icon: socialIcons.tiktok },
    settings.social_facebook && { name: 'Facebook', href: settings.social_facebook, icon: socialIcons.facebook },
    { name: 'WhatsApp', href: `https://wa.me/${(settings.studio_phone || '').replace(/[^0-9]/g, '')}`, icon: socialIcons.whatsapp },
